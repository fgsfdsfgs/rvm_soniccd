...
unsigned short localTexBuffer[0x100000];
unsigned short *texBuffer = localTexBuffer;
...
struct DrawBuffer gfxPolyList;
struct DrawBuffer polyList3D;
unsigned short *gfxPolyListIndex;
...
void GraphicsSystem_SetupPolygonLists()
{
    ...
    for (int i = 0; i < VERTEX_LIMIT; i++)
    {
        gfxPolyList.color[i].R = 0xFF;
        gfxPolyList.color[i].G = 0xFF;
        gfxPolyList.color[i].B = 0xFF;
        gfxPolyList.color[i].A = 0xFF;
    }
    for (int i = 0; i < 6404; i++)
    {
        polyList3D.color[i].R = 0xFF;
        polyList3D.color[i].G = 0xFF;
        polyList3D.color[i].B = 0xFF;
        polyList3D.color[i].A = 0xFF;
    }
}
...
{
    gfxPolyList.position[(int)gfxVertexSize].X = 0.0f;
    gfxPolyList.position[(int)gfxVertexSize].Y = 0.0f;
    gfxPolyList.color[(int)gfxVertexSize].R = tilePalette[(int)clearColour].red;
    gfxPolyList.color[(int)gfxVertexSize].G = tilePalette[(int)clearColour].green;
    gfxPolyList.color[(int)gfxVertexSize].B = tilePalette[(int)clearColour].blue;
    gfxPolyList.color[(int)gfxVertexSize].A = 0xFF;
    gfxPolyList.texCoord[(int)gfxVertexSize].X = 0.0f;
    gfxPolyList.texCoord[(int)gfxVertexSize].Y = 0.0f;
    gfxVertexSize += 1;
    gfxPolyList.position[(int)gfxVertexSize].X = (float)(SCREEN_XSIZE << 4);
    gfxPolyList.position[(int)gfxVertexSize].Y = 0.0f;
    gfxPolyList.color[(int)gfxVertexSize].R = tilePalette[(int)clearColour].red;
    gfxPolyList.color[(int)gfxVertexSize].G = tilePalette[(int)clearColour].green;
    gfxPolyList.color[(int)gfxVertexSize].B = tilePalette[(int)clearColour].blue;
    ...
    gfxVertexSize += 1;
    gfxPolyList.position[(int)gfxVertexSize].X = 0.0f;
    gfxPolyList.position[(int)gfxVertexSize].Y = 3840.0f;
    gfxPolyList.color[(int)gfxVertexSize].R = tilePalette[(int)clearColour].red;
    gfxPolyList.color[(int)gfxVertexSize].G = tilePalette[(int)clearColour].green;
    gfxPolyList.color[(int)gfxVertexSize].B = tilePalette[(int)clearColour].blue;
    gfxPolyList.color[(int)gfxVertexSize].A = 0xFF;
...
void GraphicsSystem_DrawSprite(int xPos, int yPos, int xSize, int ySize, int xBegin, int yBegin, int surfaceNum)
{
    ...
    {
        gfxPolyList.position[(int)gfxVertexSize].X = (float)(xPos << 4);
        gfxPolyList.position[(int)gfxVertexSize].Y = (float)(yPos << 4);
        gfxPolyList.color[(int)gfxVertexSize].R = 0xFF;
        gfxPolyList.color[(int)gfxVertexSize].G = 0xFF;
        gfxPolyList.color[(int)gfxVertexSize].B = 0xFF;
        gfxPolyList.color[(int)gfxVertexSize].A = 0xFF;
        gfxPolyList.texCoord[(int)gfxVertexSize].X = (float)(gfxSurface[surfaceNum].texStartX + xBegin);
        gfxPolyList.texCoord[(int)gfxVertexSize].Y = (float)(gfxSurface[surfaceNum].texStartY + yBegin);
        gfxVertexSize += 1;
        gfxPolyList.position[(int)gfxVertexSize].X = (float)((xPos + xSize) << 4);
        gfxPolyList.position[(int)gfxVertexSize].Y = (float)(yPos << 4);
        gfxPolyList.color[(int)gfxVertexSize].R = 0xFF;
        gfxPolyList.color[(int)gfxVertexSize].G = 0xFF;
        gfxPolyList.color[(int)gfxVertexSize].B = 0xFF;
        gfxPolyList.color[(int)gfxVertexSize].A = 0xFF;
        gfxPolyList.texCoord[(int)gfxVertexSize].X = (float)(gfxSurface[surfaceNum].texStartX + xBegin + xSize);
        gfxPolyList.texCoord[(int)gfxVertexSize].Y = gfxPolyList.texCoord[(int)(gfxVertexSize - 1)].Y;
        gfxVertexSize += 1;
        gfxPolyList.position[(int)gfxVertexSize].X = (float)(xPos << 4);
        gfxPolyList.position[(int)gfxVertexSize].Y = (float)((yPos + ySize) << 4);
        gfxPolyList.color[(int)gfxVertexSize].R = 0xFF;
        gfxPolyList.color[(int)gfxVertexSize].G = 0xFF;
        gfxPolyList.color[(int)gfxVertexSize].B = 0xFF;
        gfxPolyList.color[(int)gfxVertexSize].A = 0xFF;
        gfxPolyList.texCoord[(int)gfxVertexSize].X = gfxPolyList.texCoord[(int)(gfxVertexSize - 2)].X;
        gfxPolyList.texCoord[(int)gfxVertexSize].Y = (float)(gfxSurface[surfaceNum].texStartY + yBegin + ySize);
        gfxVertexSize += 1;
        gfxPolyList.position[(int)gfxVertexSize].X = gfxPolyList.position[(int)(gfxVertexSize - 2)].X;
        gfxPolyList.position[(int)gfxVertexSize].Y = gfxPolyList.position[(int)(gfxVertexSize - 1)].Y;
        gfxPolyList.color[(int)gfxVertexSize].R = 0xFF;
        gfxPolyList.color[(int)gfxVertexSize].G = 0xFF;
        gfxPolyList.color[(int)gfxVertexSize].B = 0xFF;
        gfxPolyList.color[(int)gfxVertexSize].A = 0xFF;
...
void GraphicsSystem_DrawBlendedSprite(int xPos, int yPos, int xSize, int ySize, int xBegin, int yBegin, int surfaceNum)
{
    if (gfxSurface[surfaceNum].texStartX > -1 && gfxVertexSize < VERTEX_LIMIT && xPos > -512 && xPos < 872 && yPos > -512 && yPos < 752)
    {
        ...
        gfxPolyList.color[(int)gfxVertexSize].G = 0xFF;
        gfxPolyList.color[(int)gfxVertexSize].B = 0xFF;
        gfxPolyList.color[(int)gfxVertexSize].A = 128;
        gfxPolyList.texCoord[(int)gfxVertexSize].X = (float)(gfxSurface[surfaceNum].texStartX + xBegin);
        gfxPolyList.texCoord[(int)gfxVertexSize].Y = (float)(gfxSurface[surfaceNum].texStartY + yBegin);
        gfxVertexSize += 1;
        gfxPolyList.position[(int)gfxVertexSize].X = (float)((xPos + xSize) << 4);
...
void GraphicsSystem_DrawAlphaBlendedSprite(int xPos, int yPos, int xSize, int ySize, int xBegin, int yBegin, int alpha, int surfaceNum)
{
    if (gfxSurface[surfaceNum].texStartX > -1 && gfxVertexSize < VERTEX_LIMIT && xPos > -512 && xPos < 872 && yPos > -512 && yPos < 752)
    {
        ...
        gfxPolyList.color[(int)gfxVertexSize].G = 0xFF;
        gfxPolyList.color[(int)gfxVertexSize].B = 0xFF;
        gfxPolyList.color[(int)gfxVertexSize].A = (uint8_t)alpha;
        gfxPolyList.texCoord[(int)gfxVertexSize].X = (float)(gfxSurface[surfaceNum].texStartX + xBegin);
        gfxPolyList.texCoord[(int)gfxVertexSize].Y = (float)(gfxSurface[surfaceNum].texStartY + yBegin);
        gfxVertexSize += 1;
        gfxPolyList.position[(int)gfxVertexSize].X = (float)((xPos + xSize) << 4);
...
void GraphicsSystem_DrawRectangle(int xPos, int yPos, int xSize, int ySize, int r, int g, int b, int alpha)
{
    ...
    if (gfxVertexSize < VERTEX_LIMIT)
    {
        gfxPolyList.position[(int)gfxVertexSize].X = (float)(xPos << 4);
        gfxPolyList.position[(int)gfxVertexSize].Y = (float)(yPos << 4);
        gfxPolyList.color[(int)gfxVertexSize].R = (uint8_t)r;
        gfxPolyList.color[(int)gfxVertexSize].G = (uint8_t)g;
        gfxPolyList.color[(int)gfxVertexSize].B = (uint8_t)b;
        gfxPolyList.color[(int)gfxVertexSize].A = (uint8_t)alpha;
        gfxPolyList.texCoord[(int)gfxVertexSize].X = 0.0f;
        gfxPolyList.texCoord[(int)gfxVertexSize].Y = 0.0f;
        gfxVertexSize += 1;
        ...
        gfxPolyList.color[(int)gfxVertexSize].B = (uint8_t)b;
        gfxPolyList.color[(int)gfxVertexSize].A = (uint8_t)alpha;
        gfxPolyList.texCoord[(int)gfxVertexSize].X = 10.24f;
        gfxPolyList.texCoord[(int)gfxVertexSize].Y = gfxPolyList.texCoord[(int)(gfxVertexSize - 1)].Y;
        gfxVertexSize += 1;
        gfxPolyList.position[(int)gfxVertexSize].X = (float)(xPos << 4);
        gfxPolyList.position[(int)gfxVertexSize].Y = (float)((yPos + ySize) << 4);
        ...
        gfxPolyList.color[(int)gfxVertexSize].A = (uint8_t)alpha;
        gfxPolyList.texCoord[(int)gfxVertexSize].X = 0.0f;
        gfxPolyList.texCoord[(int)gfxVertexSize].Y = 10.24f;
        gfxVertexSize += 1;
        gfxPolyList.position[(int)gfxVertexSize].X = gfxPolyList.position[(int)(gfxVertexSize - 2)].X;
        gfxPolyList.position[(int)gfxVertexSize].Y = gfxPolyList.position[(int)(gfxVertexSize - 1)].Y;
        gfxPolyList.color[(int)gfxVertexSize].R = (uint8_t)r;
...
void GraphicsSystem_DrawScaledSprite(uint8_t direction, int xPos, int yPos, int xPivot, int yPivot, int xScale, int yScale, int xSize, int ySize, int xBegin, int yBegin, int surfaceNum)
{
    if (gfxVertexSize < VERTEX_LIMIT && xPos > -512 && xPos < 872 && yPos > -512 && yPos < 752)
    {
        ...
        if (gfxSurface[surfaceNum].texStartX > -1)
        {
            ...
            gfxPolyList.texCoord[(int)gfxVertexSize].Y = (float)(gfxSurface[surfaceNum].texStartY + yBegin);
            gfxVertexSize += 1;
            gfxPolyList.position[(int)gfxVertexSize].X = (float)((xPos + xScale) << 4);
            gfxPolyList.position[(int)gfxVertexSize].Y = (float)(yPos << 4);
            gfxPolyList.color[(int)gfxVertexSize].R = 0xFF;
            gfxPolyList.color[(int)gfxVertexSize].G = 0xFF;
            gfxPolyList.color[(int)gfxVertexSize].B = 0xFF;
            ...
            gfxVertexSize += 1;
            gfxPolyList.position[(int)gfxVertexSize].X = (float)(xPos << 4);
            gfxPolyList.position[(int)gfxVertexSize].Y = (float)((yPos + yScale) << 4);
            gfxPolyList.color[(int)gfxVertexSize].R = 0xFF;
            gfxPolyList.color[(int)gfxVertexSize].G = 0xFF;
            gfxPolyList.color[(int)gfxVertexSize].B = 0xFF;
            gfxPolyList.color[(int)gfxVertexSize].A = 0xFF;
...
void GraphicsSystem_DrawScaledChar(uint8_t direction, int xPos, int yPos, int xPivot, int yPivot, int xScale, int yScale, int xSize, int ySize, int xBegin, int yBegin, int surfaceNum)
{
    if (gfxVertexSize < VERTEX_LIMIT && xPos > -8192 && xPos < 13951 && yPos > -1024 && yPos < 4864)
    {
        ...
        {
            gfxPolyList.position[(int)gfxVertexSize].X = (float)xPos;
            gfxPolyList.position[(int)gfxVertexSize].Y = (float)yPos;
            gfxPolyList.color[(int)gfxVertexSize].R = 0xFF;
            gfxPolyList.color[(int)gfxVertexSize].G = 0xFF;
            gfxPolyList.color[(int)gfxVertexSize].B = 0xFF;
            gfxPolyList.color[(int)gfxVertexSize].A = 0xFF;
            ...
            gfxPolyList.texCoord[(int)gfxVertexSize].Y = (float)(gfxSurface[surfaceNum].texStartY + yBegin);
            gfxVertexSize += 1;
            gfxPolyList.position[(int)gfxVertexSize].X = (float)(xPos + xScale);
            gfxPolyList.position[(int)gfxVertexSize].Y = (float)yPos;
            gfxPolyList.color[(int)gfxVertexSize].R = 0xFF;
            gfxPolyList.color[(int)gfxVertexSize].G = 0xFF;
            gfxPolyList.color[(int)gfxVertexSize].B = 0xFF;
            ...
            gfxVertexSize += 1;
            gfxPolyList.position[(int)gfxVertexSize].X = (float)xPos;
            gfxPolyList.position[(int)gfxVertexSize].Y = (float)(yPos + yScale);
            gfxPolyList.color[(int)gfxVertexSize].R = 0xFF;
            gfxPolyList.color[(int)gfxVertexSize].G = 0xFF;
            gfxPolyList.color[(int)gfxVertexSize].B = 0xFF;
            gfxPolyList.color[(int)gfxVertexSize].A = 0xFF;
...
void GraphicsSystem_DrawRotatedSprite(uint8_t direction, int xPos, int yPos, int xPivot, int yPivot, int xBegin, int yBegin, int xSize, int ySize, int rotAngle, int surfaceNum)
{
    ...
    if (gfxSurface[surfaceNum].texStartX > -1 && gfxVertexSize < VERTEX_LIMIT && xPos > -8192 && xPos < 13952 && yPos > -8192 && yPos < 12032)
    {
        ...
        if (direction == 0)
        {
            num3 = -xPivot;
            num4 = -yPivot;
            gfxPolyList.position[(int)gfxVertexSize].X = (float)(xPos + ((num3 * num2 + num4 * num) >> 5));
            gfxPolyList.position[(int)gfxVertexSize].Y = (float)(yPos + ((num4 * num2 - num3 * num) >> 5));
            gfxPolyList.color[(int)gfxVertexSize].R = 0xFF;
            gfxPolyList.color[(int)gfxVertexSize].G = 0xFF;
            gfxPolyList.color[(int)gfxVertexSize].B = 0xFF;
            gfxPolyList.color[(int)gfxVertexSize].A = 0xFF;
        ...
        num4 = -yPivot;
        gfxPolyList.position[(int)gfxVertexSize].X = (float)(xPos + ((xPivot * num2 + num4 * num) >> 5));
        gfxPolyList.position[(int)gfxVertexSize].Y = (float)(yPos + ((num4 * num2 - xPivot * num) >> 5));
        gfxPolyList.color[(int)gfxVertexSize].R = 0xFF;
        gfxPolyList.color[(int)gfxVertexSize].G = 0xFF;
        gfxPolyList.color[(int)gfxVertexSize].B = 0xFF;
        gfxPolyList.color[(int)gfxVertexSize].A = 0xFF;
...
void GraphicsSystem_DrawQuad(struct Quad2D* face, int rgbVal)
{
    if (gfxVertexSize < VERTEX_LIMIT)
    {
        gfxPolyList.position[(int)gfxVertexSize].X = (float)(face->vertex[0].x << 4);
        gfxPolyList.position[(int)gfxVertexSize].Y = (float)(face->vertex[0].y << 4);
        gfxPolyList.color[(int)gfxVertexSize].R = (uint8_t)(rgbVal >> 16 & 255);
        gfxPolyList.color[(int)gfxVertexSize].G = (uint8_t)(rgbVal >> 8 & 255);
        gfxPolyList.color[(int)gfxVertexSize].B = (uint8_t)(rgbVal & 255);
        ...
        {
            gfxPolyList.color[(int)gfxVertexSize].A = (uint8_t)rgbVal;
        }
        gfxPolyList.texCoord[(int)gfxVertexSize].X = 10.24f; //0.01f;
        gfxPolyList.texCoord[(int)gfxVertexSize].Y = 10.24f; //0.01f;
        gfxVertexSize += 1;
        gfxPolyList.position[(int)gfxVertexSize].X = (float)(face->vertex[1].x << 4);
        gfxPolyList.position[(int)gfxVertexSize].Y = (float)(face->vertex[1].y << 4);
        gfxPolyList.color[(int)gfxVertexSize].R = gfxPolyList.color[(int)(gfxVertexSize - 1)].R;
        gfxPolyList.color[(int)gfxVertexSize].G = gfxPolyList.color[(int)(gfxVertexSize - 1)].G;
        gfxPolyList.color[(int)gfxVertexSize].B = gfxPolyList.color[(int)(gfxVertexSize - 1)].B;
        gfxPolyList.color[(int)gfxVertexSize].A = gfxPolyList.color[(int)(gfxVertexSize - 1)].A;
        gfxPolyList.texCoord[(int)gfxVertexSize].X = 10.24f; //0.01f;
        gfxPolyList.texCoord[(int)gfxVertexSize].Y = 10.24f; //0.01f;
        gfxVertexSize += 1;
        gfxPolyList.position[(int)gfxVertexSize].X = (float)(face->vertex[2].x << 4);
        gfxPolyList.position[(int)gfxVertexSize].Y = (float)(face->vertex[2].y << 4);
        gfxPolyList.color[(int)gfxVertexSize].R = gfxPolyList.color[(int)(gfxVertexSize - 1)].R;
        gfxPolyList.color[(int)gfxVertexSize].G = gfxPolyList.color[(int)(gfxVertexSize - 1)].G;
        gfxPolyList.color[(int)gfxVertexSize].B = gfxPolyList.color[(int)(gfxVertexSize - 1)].B;
        gfxPolyList.color[(int)gfxVertexSize].A = gfxPolyList.color[(int)(gfxVertexSize - 1)].A;
        ...
        gfxPolyList.texCoord[(int)gfxVertexSize].Y = 10.24f; //0.01f;
        gfxVertexSize += 1;
        gfxPolyList.position[(int)gfxVertexSize].X = (float)(face->vertex[3].x << 4);
        gfxPolyList.position[(int)gfxVertexSize].Y = (float)(face->vertex[3].y << 4);
        gfxPolyList.color[(int)gfxVertexSize].R = gfxPolyList.color[(int)(gfxVertexSize - 1)].R;
        gfxPolyList.color[(int)gfxVertexSize].G = gfxPolyList.color[(int)(gfxVertexSize - 1)].G;
        gfxPolyList.color[(int)gfxVertexSize].B = gfxPolyList.color[(int)(gfxVertexSize - 1)].B;
        gfxPolyList.color[(int)gfxVertexSize].A = gfxPolyList.color[(int)(gfxVertexSize - 1)].A;
...
void GraphicsSystem_DrawTexturedQuad(struct Quad2D* face, int surfaceNum)
{
    if (gfxVertexSize < VERTEX_LIMIT)
    {
        ...
        gfxPolyList.color[(int)gfxVertexSize].B = 0xFF;
        gfxPolyList.color[(int)gfxVertexSize].A = 0xFF;
        gfxPolyList.texCoord[(int)gfxVertexSize].X = (float)(gfxSurface[surfaceNum].texStartX + face->vertex[0].u);
        gfxPolyList.texCoord[(int)gfxVertexSize].Y = (float)(gfxSurface[surfaceNum].texStartY + face->vertex[0].v);
        gfxVertexSize += 1;
        gfxPolyList.position[(int)gfxVertexSize].X = (float)(face->vertex[1].x << 4);
        gfxPolyList.position[(int)gfxVertexSize].Y = (float)(face->vertex[1].y << 4);
        gfxPolyList.color[(int)gfxVertexSize].R = 0xFF;
        ...
        gfxPolyList.color[(int)gfxVertexSize].B = 0xFF;
        gfxPolyList.color[(int)gfxVertexSize].A = 0xFF;
        gfxPolyList.texCoord[(int)gfxVertexSize].X = (float)(gfxSurface[surfaceNum].texStartX + face->vertex[1].u);
        gfxPolyList.texCoord[(int)gfxVertexSize].Y = (float)(gfxSurface[surfaceNum].texStartY + face->vertex[1].v);
        gfxVertexSize += 1;
        gfxPolyList.position[(int)gfxVertexSize].X = (float)(face->vertex[2].x << 4);
        gfxPolyList.position[(int)gfxVertexSize].Y = (float)(face->vertex[2].y << 4);
        gfxPolyList.color[(int)gfxVertexSize].R = 0xFF;
        ...
        gfxPolyList.color[(int)gfxVertexSize].B = 0xFF;
        gfxPolyList.color[(int)gfxVertexSize].A = 0xFF;
        gfxPolyList.texCoord[(int)gfxVertexSize].X = (float)(gfxSurface[surfaceNum].texStartX + face->vertex[2].u);
        gfxPolyList.texCoord[(int)gfxVertexSize].Y = (float)(gfxSurface[surfaceNum].texStartY + face->vertex[2].v);
        gfxVertexSize += 1;
        gfxPolyList.position[(int)gfxVertexSize].X = (float)(face->vertex[3].x << 4);
        gfxPolyList.position[(int)gfxVertexSize].Y = (float)(face->vertex[3].y << 4);
        gfxPolyList.color[(int)gfxVertexSize].R = 0xFF;
        ...
        gfxPolyList.color[(int)gfxVertexSize].B = 0xFF;
        gfxPolyList.color[(int)gfxVertexSize].A = 0xFF;
        gfxPolyList.texCoord[(int)gfxVertexSize].X = (float)(gfxSurface[surfaceNum].texStartX + face->vertex[3].u);
        gfxPolyList.texCoord[(int)gfxVertexSize].Y = (float)(gfxSurface[surfaceNum].texStartY + face->vertex[3].v);
        gfxVertexSize += 1;
        gfxIndexSize += 6;
    }
}
