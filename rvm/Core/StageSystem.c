...
void StageSystem_Draw3DFloorLayer(uint8_t layerNum)
{
    ...
    polyList3D.position[vertexSize3D].X = 0.0f;
    polyList3D.position[vertexSize3D].Y = 0.0f;
    polyList3D.position[vertexSize3D].Z = 0.0f;
    polyList3D.texCoord[vertexSize3D].X = 512.0f;
    polyList3D.texCoord[vertexSize3D].Y = 0.0f;
    polyList3D.color[vertexSize3D].R = 0xff;
    polyList3D.color[vertexSize3D].G = 0xff;
    polyList3D.color[vertexSize3D].B = 0xff;
    polyList3D.color[vertexSize3D].A = 0xff;
    vertexSize3D = (uint16_t)(vertexSize3D + 1);
    polyList3D.position[vertexSize3D].X = 4096.0f;
    polyList3D.position[vertexSize3D].Y = 0.0f;
    polyList3D.position[vertexSize3D].Z = 0.0f;
    polyList3D.texCoord[vertexSize3D].X = 1024.0f;
    polyList3D.texCoord[vertexSize3D].Y = 0.0f;
    polyList3D.color[vertexSize3D].R = 0xff;
    polyList3D.color[vertexSize3D].G = 0xff;
    polyList3D.color[vertexSize3D].B = 0xff;
    ...
    polyList3D.position[vertexSize3D].X = 0.0f;
    polyList3D.position[vertexSize3D].Y = 0.0f;
    polyList3D.position[vertexSize3D].Z = 4096.0f;
    polyList3D.texCoord[vertexSize3D].X = 512.0f;
    polyList3D.texCoord[vertexSize3D].Y = 512.0f;
    polyList3D.color[vertexSize3D].R = 0xff;
    polyList3D.color[vertexSize3D].G = 0xff;
    polyList3D.color[vertexSize3D].B = 0xff;
    polyList3D.color[vertexSize3D].A = 0xff;
                ...
                if (sinValue512 > -1 && sinValue512 < layerWidth && cosValue512 > -1 && cosValue512 < layerHeight)
                {
                    ...
                    if (gfxData[tileIndex] > 0)
                    {
                        ...
                        switch (tileDirections[tileIndex])
                        {
                            case 0:
                            {
                                polyList3D.position[vertexSize3D].X = (float)sinValue512;
                                polyList3D.position[vertexSize3D].Y = 0.0f;
                                polyList3D.position[vertexSize3D].Z = (float)cosValue512;
                                polyList3D.texCoord[vertexSize3D].X = tileUVArray[gfxData[tileIndex] + tileOffset];
                                tileOffset++;
                                polyList3D.texCoord[vertexSize3D].Y = tileUVArray[gfxData[tileIndex] + tileOffset];
                                tileOffset++;
                                polyList3D.color[vertexSize3D].R = 0xff;
                                polyList3D.color[vertexSize3D].G = 0xff;
                                polyList3D.color[vertexSize3D].B = 0xff;
                                polyList3D.color[vertexSize3D].A = 0xff;
                                vertexSize3D = (uint16_t)(vertexSize3D + 1);
                                polyList3D.position[vertexSize3D].X = (float)(sinValue512 + 16);
                                polyList3D.position[vertexSize3D].Y = 0.0f;
                                polyList3D.position[vertexSize3D].Z = polyList3D.position[vertexSize3D - 1].Z;
                                polyList3D.texCoord[vertexSize3D].X = tileUVArray[gfxData[tileIndex] + tileOffset];
                                tileOffset++;
                                polyList3D.texCoord[vertexSize3D].Y = polyList3D.texCoord[vertexSize3D - 1].Y;
                                polyList3D.color[vertexSize3D].R = 0xff;
                                polyList3D.color[vertexSize3D].G = 0xff;
                                polyList3D.color[vertexSize3D].B = 0xff;
                                polyList3D.color[vertexSize3D].A = 0xff;
                                vertexSize3D = (uint16_t)(vertexSize3D + 1);
                                polyList3D.position[vertexSize3D].X = polyList3D.position[vertexSize3D - 2].X;
                                polyList3D.position[vertexSize3D].Y = 0.0f;
                                polyList3D.position[vertexSize3D].Z = (float)(cosValue512 + 16);
                                polyList3D.texCoord[vertexSize3D].X = polyList3D.texCoord[vertexSize3D - 2].X;
                                polyList3D.texCoord[vertexSize3D].Y = tileUVArray[gfxData[tileIndex] + tileOffset];
                                polyList3D.color[vertexSize3D].R = 0xff;
                                polyList3D.color[vertexSize3D].G = 0xff;
                                polyList3D.color[vertexSize3D].B = 0xff;
            ...
            for (i = sCREENXSIZE; i > 0; i--)
            {
                if (visualPlane[gfxIndex] == highPlane && gfxDataPos[gfxIndex] > 0)
                {
                    ...
                    switch (direction[gfxIndex])
                    {
                        case 0:
                        {
                            gfxPolyList.position[gfxVertexSize].X = (float)deformX1;
                            gfxPolyList.position[gfxVertexSize].Y = (float)deformY;
                            gfxPolyList.texCoord[gfxVertexSize].X = tileUVArray[gfxDataPos[gfxIndex] + tileUvOffset];
                            tileUvOffset++;
                            gfxPolyList.texCoord[gfxVertexSize].Y = tileUVArray[gfxDataPos[gfxIndex] + tileUvOffset];
                            tileUvOffset++;
                            gfxPolyList.color[gfxVertexSize].R = 0xff;
                            gfxPolyList.color[gfxVertexSize].G = 0xff;
                            gfxPolyList.color[gfxVertexSize].B = 0xff;
                            gfxPolyList.color[gfxVertexSize].A = 0xff;
                            gfxVertexSize = gfxVertexSize + 1;
                            gfxPolyList.position[gfxVertexSize].X = (float)(deformX1 + 0x100);
                            gfxPolyList.position[gfxVertexSize].Y = (float)deformY;
                            gfxPolyList.texCoord[gfxVertexSize].X = tileUVArray[gfxDataPos[gfxIndex] + tileUvOffset];
                            tileUvOffset++;
                            gfxPolyList.texCoord[gfxVertexSize].Y = gfxPolyList.texCoord[gfxVertexSize - 1].Y;
                            gfxPolyList.color[gfxVertexSize].R = 0xff;
                            gfxPolyList.color[gfxVertexSize].G = 0xff;
                            gfxPolyList.color[gfxVertexSize].B = 0xff;
                            gfxPolyList.color[gfxVertexSize].A = 0xff;
                            gfxVertexSize = gfxVertexSize + 1;
                            gfxPolyList.position[gfxVertexSize].X = (float)deformX2;
                            gfxPolyList.position[gfxVertexSize].Y = (float)(deformY + 0x100);
                            gfxPolyList.texCoord[gfxVertexSize].X = gfxPolyList.texCoord[gfxVertexSize - 2].X;
                            gfxPolyList.texCoord[gfxVertexSize].Y = tileUVArray[gfxDataPos[gfxIndex] + tileUvOffset];
                            gfxPolyList.color[gfxVertexSize].R = 0xff;
                            gfxPolyList.color[gfxVertexSize].G = 0xff;
                            gfxPolyList.color[gfxVertexSize].B = 0xff;
                            gfxPolyList.color[gfxVertexSize].A = 0xff;
                            gfxVertexSize = gfxVertexSize + 1;
                            gfxPolyList.position[gfxVertexSize].X = (float)(deformX2 + 0x100);
                            gfxPolyList.position[gfxVertexSize].Y = gfxPolyList.position[gfxVertexSize - 1].Y;
                            gfxPolyList.texCoord[gfxVertexSize].X = gfxPolyList.texCoord[gfxVertexSize - 2].X;
                            gfxPolyList.texCoord[gfxVertexSize].Y = gfxPolyList.texCoord[gfxVertexSize - 1].Y;
                            gfxPolyList.color[gfxVertexSize].R = 0xff;
                            gfxPolyList.color[gfxVertexSize].G = 0xff;
                ...
                if (visualPlane[gfxIndex] == highPlane && gfxDataPos[gfxIndex] > 0)
                {
                    ...
                    switch (direction[gfxIndex])
                    {
                        case 0:
                        {
                            ...
                            gfxVertexSize = gfxVertexSize + 1;
                            gfxPolyList.position[gfxVertexSize].X = (float)deformX2;
                            gfxPolyList.position[gfxVertexSize].Y = (float)(deformY + 128);
                            gfxPolyList.texCoord[gfxVertexSize].X = gfxPolyList.texCoord[gfxVertexSize - 2].X;
                            gfxPolyList.texCoord[gfxVertexSize].Y = tileUVArray[gfxDataPos[gfxIndex] + tileUvOffset] - 8;
                            gfxPolyList.color[gfxVertexSize].R = 0xff;
                            gfxPolyList.color[gfxVertexSize].G = 0xff;
                            gfxPolyList.color[gfxVertexSize].B = 0xff;
                            gfxPolyList.color[gfxVertexSize].A = 0xff;
